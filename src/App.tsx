            ...
            <div className="container mx-auto px-6 relative flex items-center justify-between w-full h-full">
              ...
              <div className="hidden lg:flex gap-4 xl:gap-5 justify-end items-center w-1/3">
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-7 h-7 rounded-full bg-[#FC8019] text-white flex items-center justify-center cursor-none hover:scale-110 transition-transform shadow-md p-1.5"
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-7 h-7 rounded-full bg-[#CB192E] text-white flex items-center justify-center cursor-none hover:scale-110 transition-transform shadow-md p-1.5"
